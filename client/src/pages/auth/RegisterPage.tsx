...
export function RegisterPage() {
  ...
  return (
    <div className="cricket-field min-h-screen flex items-center justify-center px-4 py-8 bg-gradient-to-br from-green-100 to-green-200">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center bg-gradient-to-r from-amber-100/80 to-green-100/80 p-8 rounded-2xl border-4 border-amber-300 shadow-2xl">
          ...
          <p className="text-amber-700 font-medium text-lg">Create your cricket helper account</p>
          <div className="mt-4 text-sm text-amber-600">
            🌟 Join the cricket improvement journey
          </div>
        </div>
